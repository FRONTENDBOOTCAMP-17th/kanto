...
> **공식**: 개인 기여도(%) = 본인 획득 점수 합 ÷ 팀 전체 점수 합 × 100
>
> 공동 작업 기능은 참여 비율로 점수를 나눠 가짐: **기능별 획득 점수 = 기능 난이도 점수 × 본인 참여 비율**
...
| 실시간 채팅 | 4 | - | 2.40 | 0.60 | 1.00 |
| Google Maps | 3 | 0.90 | - | 0.90 | 1.20 |
...
| **합계** | **46** | **9.70** | **11.90** | **11.05** | **13.35** |
| **기여 비율** | | **21.1%** | **25.9%** | **24.0%** | **29.0%** |
