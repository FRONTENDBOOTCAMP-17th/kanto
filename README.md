...
> - **역할 난이도**: 본인이 담당한 기능 중 최고 난이도 등급 점수 → 팀 전체 합 대비 비율(%)
...
| **합계 (79pts 기준)** | **79** | **15.40 → 19.5%** | **27.20 → 34.4%** | **17.05 → 21.6%** | **19.35 → 24.5%** |

#### ② 역할 난이도 (담당 기능 최고 등급)

| | 박소유 | 김도혁 | 이동근 | 임태형 |
| --- | :---: | :---: | :---: | :---: |
| 최고 등급 | S (5) | A (4) | S (5) | S (5) |
| 비율 (합계 19pts) | 26.3% | 21.1% | 26.3% | 26.3% |

#### ③ 최종 기여도 = (정량 점수 × 0.5) + (역할 난이도 × 0.5)

| | 박소유 | 김도혁 | 이동근 | 임태형 |
| --- | :---: | :---: | :---: | :---: |
| 정량 점수 (×0.5) | 19.5% × 0.5 = 9.75 | 34.4% × 0.5 = 17.20 | 21.6% × 0.5 = 10.80 | 24.5% × 0.5 = 12.25 |
| 역할 난이도 (×0.5) | 26.3% × 0.5 = 13.15 | 21.1% × 0.5 = 10.55 | 26.3% × 0.5 = 13.15 | 26.3% × 0.5 = 13.15 |
