      ...
      <form onSubmit={handleSubmit} className="px-4 sm:px-6 lg:px-8">
        <div className="flex items-center bg-white border-2 border-gray-200 rounded-full h-11 md:h-14 px-2 focus-within:border-teal-400 transition-colors">
          ...
          <button
            ...
            className="md:hidden flex items-center gap-1 px-3 h-8 rounded-full font-semibold text-sm whitespace-nowrap transition-colors select-none hover:bg-gray-100 active:scale-100"
          >
          ...
          <div className="hidden md:block relative shrink-0" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-1 px-3 h-8 rounded-full font-semibold text-sm whitespace-nowrap transition-colors select-none hover:bg-gray-100 active:scale-100"
            >
              <span>{t(`category.${selectedCategory.catKey}`)}</span>
