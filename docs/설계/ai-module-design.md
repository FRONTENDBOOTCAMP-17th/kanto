...
| AI 챗봇 | 플랫폼 도우미 플로팅 위젯 | 플로팅 버튼 클릭 | 불필요 |
...
플로팅 버튼으로 언제든지 접근 가능한 플랫폼 도우미. 비회원도 사용 가능.  
플랫폼 사용법·거래 팁 안내에 특화한다.
...
- **콘텐츠 자동 검열**: 게시글 작성/수정 시 운영 정책 위반 콘텐츠 차단
