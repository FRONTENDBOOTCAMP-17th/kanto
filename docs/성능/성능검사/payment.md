...
|---|:---:|:---:|:---:|:---:|:---:|:---:|
| Perf | 78 | 56 | 60 | 58 | 98 | **100** |
| LCP | 4.9s 🔴 | 7.14s | 7.20s | **7.17s 🔴** | 0.9s 🟢 | **0.7s 🟢** |
| TBT | 230ms | 642ms | 537ms | 589.5ms | 90ms | 23ms |
| SI | 1.9s | 5.44s | 4.15s | 4.79s | 0.7s | 0.53s |

**🖥️ 데스크탑 — 확정 개선. 📱 모바일 — 신뢰도 있는 악화**(LCP 두 측정 7.14s/7.20s로 거의 일치): LCP 4.9s→7.17s, SI도 1.9s→4.79s로 크게 나빠짐. service·youth와 거의 같은 폭(LCP ~7.1~7.3s대로 수렴)이라 SSR 전환 대상 페이지 공통 원인이 있다는 심증이 더 굳어짐.
